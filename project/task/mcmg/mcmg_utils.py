# Modified version of: https://github.com/DobromirM/MCMG/blob/main/utils.py
...
def get_tr_va_te_data(data, day_first):
    ...
    region_training_samples, region_validation_samples, region_testing_samples, region_training_validation_samples = get_training_testing(
        region_sequences)
    category_training_samples, category_validation_samples, category_testing_samples, category_training_validation_samples = get_training_testing(
        cate_sequences)
    time_training_samples, time_validation_samples, time_testing_samples, time_training_validation_samples = get_training_testing(
        time_sequences)
    POI_distance_training_samples, POI_distance_validation_samples, POI_distance_testing_samples, POI_distance_training_validation_samples = get_training_testing(
        POI_dist_sequences)
    regi_distance_training_samples, regi_distance_validation_samples, regi_distance_testing_samples, regi_distance_training_validation_samples = get_training_testing(
        region_dist_sequences)
    ...
    POI_distance_train_valid_pre, POI_distance_train_valid_target = get_PreTarget(
        POI_distance_training_validation_samples)
    ...
    regi_distance_train_valid_pre, regi_distance_train_valid_target = get_PreTarget(
